...
SWIFT_MODULE_NAMESPACE_PUSH("Swoosh")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC6Swoosh11AppDelegate")
...
SWIFT_CLASS("_TtC6Swoosh12BorderButton")
...
SWIFT_CLASS("_TtC6Swoosh7SkillVC")
...
SWIFT_CLASS("_TtC6Swoosh9WelcomeVC")
